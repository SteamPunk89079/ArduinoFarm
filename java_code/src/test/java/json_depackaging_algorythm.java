...
public class json_depackaging_algorythm {
    ...
    public static void main(String[] args) {
        ...
        String reading1 = "{\"date\":{\"date_time\":\"6-13-2024 || 0:28:58\"},\"sensor1\":{\"S_nr\":1,\"temp\":26.2,\"hum\":26},\"sensor2\":{\"S_nr\":2,\"temp2\":25.8,\"hum2\":26},\"sensor3\":{\"S_nr\":3,\"temp3\":25.7,\"hum3\":26}}";


        System.out.println(reading1);


        if (isValidReading(reading1)) {
            System.out.println("Valid data string.");

            ArrayList<String> processed_data = processReading(reading1);;
            Reading READING = package_data(processed_data);
